...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('public/admin/assets/'); ?>plugins/images/favicon.png">
    <!-- Custom CSS -->
   <link href="<?php echo base_url('public/admin/assets/'); ?>css/style.min.css" rel="stylesheet">
