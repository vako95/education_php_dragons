...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  <h1 class="page-header">Visitors Account</h1>
  <div class="row">
    <div class="col-xs-12">
          ...
          ?>
              <tr>
                ...
                <td class="text-right">
                    ...
                    <a href="<?php echo base_url('deactivate_visitor/' .$id); ?>" onclick="return confirm('Are you sure you want do deactivate this account?')" class="btn btn-xs
