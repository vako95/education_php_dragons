        ...
        <div class="col-md-offset-2">
            <div class="row">
                <div class="col-xs-8 col-lg-8">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                        <div class="panel panel-default ">
                            <div class="panel-heading"></div>
                            <div class="panel-body" id="newUserForm">
                                <div class="form-group" id="newUserForm">
                                    <label>First Name</label>
                                    <input type="text" class="form-control" name="fname" value="<?php echo set_value('fname', $user->fname); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Middle Name</label>
                                    <input type="text" class="form-control" name="mname" value="<?php echo set_value('mname', $user->mname); ?>">
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label>Last Name</label>
                                            <input type="text" class="form-control" name="lname" value="<?php echo set_value('lname', $user->lname); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Suffix Name</label>
                                            <input type="text" class="form-control" name="xname" value="<?php echo set_value('xname', $user->xname); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="role" class="form-control">
                                        <option value="">-</option>
                                        <option <?php echo ($user->role == USER_ROLE_ADMIN) ? 'selected' : ''; ?> value="<?php echo USER_ROLE_ADMIN; ?>">Adminstrator</option>
                                        <option <?php echo ($user->role == USER_ROLE_MANAGER) ? 'selected' : ''; ?> value="<?php echo USER_ROLE_MANAGER; ?>">Manager</option>
                                    </select>
                                </div>

                                <div class="panel-footer">
                                    <input type="submit" name="submit" value="Update" class="btn btn-primary btn-lg btn-login">
