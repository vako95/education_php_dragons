...
<div class="row">
    ...
    <div class="white-box">
        ...
        <form action="<?php echo base_url('admin_creat_popular_act'); ?>" method="post" enctype="multipart/form-data" class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
    ...
    <div class="form-row">
        ...
        <input class="input-suma-credit form-control" id="price" type="text" name="price" inputmode="decimal" autocomplete="off">
    </div>
    <br>
    <div class="col-xs-6 col-md-2 col-lg-2 col-sm-2" style="float: left;">
        <label for="student">Students</label>
        <input name="student" type="number" class="form-control" id="student">
    </div>
    <div class="col-xs-6 col-md-2 col-lg-2 col-sm-2" style="float: left;">
